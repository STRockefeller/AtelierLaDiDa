...
{
	/// <summary>
	/// Database       : atelierLaDiDaA17Sqlite
	/// Data Source    : atelierLaDiDaA17Sqlite
	/// Server Version : 3.24.0
	/// </summary>
	public partial class AtelierLaDiDaA17SqliteDB : LinqToDB.Data.DataConnection
	{
		public ITable<Sophie> Sophie { get { return this.GetTable<Sophie>(); } }

		public AtelierLaDiDaA17SqliteDB()
		{
			InitDataContext();
			InitMappingSchema();
		}

		public AtelierLaDiDaA17SqliteDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public partial class Sophie
	{
		...
		[Column(),      Nullable] public char?   TRIAL556   { get; set; } // char(1)
	}
}
